export const PROJECTS = [
  {
    ...
    cardBg: 'bg-blue',
    badges: ['Liderança de produto', 'Discovery e Delivery', 'Cofundador'],
  ...
  },
  {
    ...
    cardBg: 'bg-blue',
    badges: ['Liderança de produto', 'Design inclusivo', 'Double Diamond'],
  ...
  },
  {
    ...
    cardBg: 'bg-blue',
    badges: ['Discovery', 'Pesquisa com usuários', 'Mobile'],
  ...
  },
  {
    ...
    cardBg: 'bg-blue',
    badges: ['Produto de dados', 'Dashboard', 'Priorização'],
